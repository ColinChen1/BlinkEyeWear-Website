$(document).ready(function(){
     $('#member1').click(function(){
    	$('#member1-info').animate({ "bottom": "-=200px" }, "fast" );
    ...
    $('#member2').click(function(){
    	$('#member2-info').animate({ "bottom": "-=200px" }, "fast" );
    ...
    $('#member2-info').click(function(){
     ...
     $('#member3').click(function(){
    	$('#member3-info').animate({ "bottom": "-=200px" }, "fast" );
    ...
    $('#member3-info').click(function(){
     ...
     $('#member4').click(function(){
    	$('#member4-info').animate({ "bottom": "-=200px" }, "fast" );
    ...
    $('#member4-info').click(function(){
     ...
     $('#member5').click(function(){
    	$('#member5-info').animate({ "bottom": "-=200px" }, "fast" );
